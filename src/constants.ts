...
export const SUBAGENT_CREDENTIAL_STALL_THRESHOLD_MS = 2 * 60 * 1000;
export const SUBAGENT_CREDENTIAL_STALL_FORCED_FINALIZE_GRACE_MS = 1_000;
export const SUBAGENT_SEMANTIC_COMPLETION_GRACE_MS = 15_000;
export const SUBAGENT_SEMANTIC_COMPLETION_HARD_KILL_DELAY_MS = 5_000;
export const SUBAGENT_SEMANTIC_COMPLETION_FORCED_FINALIZE_GRACE_MS = 5_000;
export const SUBAGENT_DEFAULT_MAX_CONCURRENCY = 4;
export const SUBAGENT_MIN_CONCURRENCY = 1;
export const SUBAGENT_MAX_CONFIGURABLE_CONCURRENCY = 16;
export const SUBAGENT_MAX_CONCURRENCY = SUBAGENT_DEFAULT_MAX_CONCURRENCY;
